    ...
    const { data, setData, post, processing, errors } = useForm(
        isEdit
            ? {
                  ...
                  completion_mode: document.completion_mode ?? "test",
                  file: null,
              }
            : {
                  title: "", type: "", description: "", version: 1, file: null,
                  completion_mode: "test",
                  position_ids: [],
            ...
            <div className="max-w-xl">
                ...
                >
                    ...
                    <div>
                        ...
                        <select
                            value={data.completion_mode}
                            onChange={(e) => setData("completion_mode", e.target.value)}
                            className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                                errors.completion_mode ? "border-red-300" : "border-gray-200"
                            }`}
                        >
                            <option value="test">Чтение документа и тест</option>
                            <option value="confirmation">Отметка без теста (видео + ознакомление)</option>
                        </select>
                        ...
                        {data.completion_mode === "confirmation" && (
                            <p className="mt-1 text-xs text-gray-400">
                                Например, первичный инструктаж: видеоролики и устный инструктаж добавляются в карточке
                                документа после сохранения. Тест для такого документа не создаётся.
                            </p>
                        )}
                    </div>
                    )}
