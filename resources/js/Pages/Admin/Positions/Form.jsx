...
export default function PositionForm({ position, departments }) {
    ...
    function submit(e) {
        e.preventDefault();
        isEdit ? put(route("admin.positions.update", position.id))
        ...
        <AppLayout title={isEdit ? "Редактировать должность" : "Добавить должность"}>
            ...
            <div className="max-w-md">
                <p className="text-xs text-gray-400 mb-6">
                    <Link href={route("admin.positions.index")} className="hover:underline">← Должности</Link>
                </p>
